        ...
        <section className="main-helpandstudy">
            <div className="helpandstudy-point sizeblock">
                ...
                <div className="helpandstudy-point__textblok">
                    ...
                    <div className="helpandstudy-point__text">Если в процессе обучения возникнут сложности, вы всегда сможете задать вопрос своему наставнику.Раз в несколько уроков вы будете получать большое задание, которое нужно будет сдавать на проверку код-ревьюеру. Он внимательно изучит ваш код, найдет ошибки и поможет вам стать лучше.</div>
                </div>
            </div>
            <div className="helpandstudy-point sizeblock">
                <div className="helpandstudy-point__textblok">
